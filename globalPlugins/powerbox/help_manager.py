...
def show_global_help(plugin_obj):
    ...
    help_lines = [
        ...
        f"{_('Master Volume Up')}: {get_current_gesture(plugin_obj, 'masterVolumeUp', 'NVDA+Windows+Up Arrow')}",
        f"{_('Master Volume Down')}: {get_current_gesture(plugin_obj, 'masterVolumeDown', 'NVDA+Windows+Down Arrow')}",
        f"{_('Master Volume Mute')}: {get_current_gesture(plugin_obj, 'masterVolumeMute', 'NVDA+Windows+M')}\n",

        _("--- Active Application Audio ---"),
        f"{_('App Volume Up')}: {get_current_gesture(plugin_obj, 'appVolumeUp', 'NVDA+Windows+Shift+Up Arrow')}",
        f"{_('App Volume Down')}: {get_current_gesture(plugin_obj, 'appVolumeDown', 'NVDA+Windows+Shift+Down Arrow')}",
        f"{_('App Volume Mute')}: {get_current_gesture(plugin_obj, 'appVolumeMute', 'NVDA+Windows+Shift+M')}\n",

        _("--- Media & Browser Navigation ---"),
        ...
        f"{_('Classic Context Menu')}: {get_current_gesture(plugin_obj, 'pressClassicApplications', 'NVDA+Windows+Shift+A')}\n",
